...
//Makes sure the Circmin is not below 0.00. Resets the value to 0.00 if it does. 
if (Circmin < 0.00) {
		Circmin = 0.00;	
		//Error Message Box
		showMessage("Circularity must be within 0.00 to 1.00. Lower range reset to 0.00");
		}
	//Makes sure the Circmin does not exceed 1.00. Resets the value to 1.00 if it does.
...
//Makes sure the Circmax does not exceed 1.00. Resets the value to 1.00 if it does.
if (Circmax > 1.00) {
		Circmax = 1.00;
		//Error Message Box
	...
	//Makes sure the Circmax is not below 0.00. Resets the value to 0.00 if it does.
